...
export default function HeroSection() {
    return (
        <section id="home" className="bg-[#F9F5FB] relative overflow-hidden">
            <div className="absolute top-[-80px] right-[-80px] w-[420px] h-[420px] bg-purple-200/30 rounded-full blur-3xl pointer-events-none" />
            <div className="absolute bottom-0 left-[-60px] w-[320px] h-[320px] bg-pink-200/20 rounded-full blur-3xl pointer-events-none" />
            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 relative z-10">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center pb-20 pt-6 lg:pt-10">
                    ...
                    <div className="space-y-6 text-center lg:text-left order-2 lg:order-1">
                        ...
                        <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start pt-4 border-t border-purple-100">
                            <div className="flex shrink-0" style={{gap:-10}}>
                                {['linear-gradient(135deg,#a78bfa,#6366f1)','linear-gradient(135deg,#f472b6,#f43f5e)','linear-gradient(135deg,#fbbf24,#f97316)','linear-gradient(135deg,#34d399,#06b6d4)'].map((g,i)=>(
                                    <span key={i} style={{width:36,height:36,borderRadius:'50%',background:g,border:'2px solid #fff',display:'inline-block',marginLeft:i===0?0:-10,flexShrink:0}} />
                                ))}
                            </div>
                            <div className="text-center sm:text-left">
                                <div className="flex items-center justify-center sm:justify-start gap-0.5">
                                    ...
                                    <span className="ml-1 text-sm font-bold text-[#1E0B3C]">4.9</span>
                                </div>
                                <p className="text-xs text-slate-500 mt-0.5">Trusted by 1,200+ wellness studios</p>
                            </div>
                        </div>
                    </div>
