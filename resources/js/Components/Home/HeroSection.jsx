                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center pb-20 pt-6 lg:pt-10">
                    ...
                    <div className="space-y-6 text-center lg:text-left order-2 lg:order-1">
                        <div className="inline-flex items-center gap-2 bg-pink-100 border border-pink-200 px-4 py-1.5 rounded-full">
                            ...
                            <span className="text-[11px] font-bold uppercase tracking-[0.14em] text-pink-600">Integrated Practice Management</span>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2">
                            <a href="#booking" className="inline-flex justify-center items-center bg-[#5B2EFF] hover:bg-purple-700 text-white font-medium px-8 py-4 rounded-full shadow-xl shadow-purple-500/25 transition-colors text-sm">
                                Book a Demo
                            </a>
                            <a href="#about" className="inline-flex justify-center items-center gap-3 text-[#1E0B3C] font-medium text-sm group">
                    ...
                    <div className="relative order-1 lg:order-2">
                        ...
                        <div className="relative bg-white rounded-[2rem] p-3 shadow-2xl border border-purple-100 overflow-hidden">
                            <div style={{borderRadius:'1.6rem',minHeight:440,position:'relative',overflow:'hidden'}}>
                                <img
