...
const AVAILABILITY_STYLES = {
    ...
    'Off Today': 'bg-slate-100 text-slate-500 border-slate-200',
};
        ...
        <AuthenticatedLayout title="Owner Dashboard">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
                <div className="bg-white p-5 rounded-xl border border-slate-200/80 shadow-sm flex items-center justify-between">
                    <div>
                        <p className="text-xs font-medium text-slate-500 uppercase tracking-wider">Today's Appointments</p>
                        <h3 className="text-2xl font-bold text-slate-900 mt-1">{stats?.todayAppointments || 0}</h3>
                    </div>
                    <div className="h-10 w-10 rounded-lg bg-violet-50 text-violet-700 flex items-center justify-center">
                ...
                <div className="bg-white p-5 rounded-xl border border-slate-200/80 shadow-sm flex items-center justify-between">
                    <div>
                        <p className="text-xs font-medium text-slate-500 uppercase tracking-wider">Total Active Clients</p>
                        <h3 className="text-2xl font-bold text-slate-900 mt-1">{stats?.totalClients || 0}</h3>
                    </div>
                ...
                <div className="bg-white p-5 rounded-xl border border-slate-200/80 shadow-sm flex items-center justify-between">
                    <div>
                        <p className="text-xs font-medium text-slate-500 uppercase tracking-wider">Clinic Locations</p>
                        <h3 className="text-2xl font-bold text-slate-900 mt-1">{stats?.activeLocations || 0}</h3>
                    </div>
                ...
                <div className="bg-white p-5 rounded-xl border border-slate-200/80 shadow-sm flex items-center justify-between">
                    <div>
                        <p className="text-xs font-medium text-slate-500 uppercase tracking-wider">Revenue (MTD)</p>
                        <h3 className="text-2xl font-bold text-slate-900 mt-1">{stats?.monthlyRevenue || '$0'}</h3>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-white rounded-xl border border-slate-200/80 shadow-sm overflow-hidden">
                    <div className="px-6 py-4 border-b border-slate-100 flex items-center space-x-2 bg-slate-50/50">
                        ...
                        <h2 className="font-semibold text-slate-800 text-base">Outstanding Invoices</h2>
                    </div>
                ...
                <div className="bg-white rounded-xl border border-slate-200/80 shadow-sm overflow-hidden">
                    <div className="px-6 py-4 border-b border-slate-100 flex items-center space-x-2 bg-slate-50/50">
                        <UserCog className="w-4 h-4 text-violet-700" />
                        <h2 className="font-semibold text-slate-800 text-base">Staff Availability</h2>
                    </div>
                    <div className="divide-y divide-slate-100">
                        {staff && staff.length > 0 ? staff.map((s, i) => (
                            ...
                            <div className="p-8 text-center text-slate-500 text-sm">No staff yet.</div>
                        )}
                    </div>
                </div>
            </div>
