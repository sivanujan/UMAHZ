            ...
            <div className="max-w-md w-full relative z-10">
                ...
                <div className="bg-white rounded-3xl shadow-xl border border-purple-100 p-8 space-y-6 text-center">
                    <div className="w-14 h-14 rounded-2xl bg-purple-50 flex items-center justify-center mx-auto">
                        <MailCheck className="w-7 h-7 text-[#5B2EFF]" />
                    </div>

                    <div>
                        <h1 className="text-2xl font-bold text-[#1E0B3C] tracking-tight">Check Your Email</h1>
                        <p className="mt-2 text-sm text-slate-500 leading-relaxed">
                            We sent a verification link to <span className="font-semibold text-[#1E0B3C]">{email}</span>. Click it to activate your account.
                        </p>
                    </div>
